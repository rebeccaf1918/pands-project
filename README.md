...
- Consequently, I can make the assumption that any iris flower with a petal length of less than approx 2.1cm must be an Iris Setosa. Also, any Iris flower with a petal width of less than 0.6cm must be an Iris Setosa. This is evidenced by the fact that the Petal Length and Petal Width distplots have little overlap, with the Iris Setosa being quite seperate from Iris Versicolour and Iris Virginica and thus Petal Length and Petal Width are good classification features. 
...
- The heatmap and scatterplot show that there is almost perfect correlation between petal length and petal width and so for each of the species, petal length will correspond to petal width, with the larger the petal length, the petal width will increase and vice versa. This is evident by the scatter plot of the petal length x petal width, with almost a stright line drawable through many dots in the scatterplot. 
- The petal lengths and petal widths correspond with each other, and with the species.
- For Iris Setosa, its evident that there is a strong correlation between its sepal length and sepal width and thus, longer sepal lengths will mean longer sepal widths too and vice versa. The correlation between sepal length and width is not as strong within the other two species.
- However, for Iris Virginica, there is a strong correlation between petal length and petal width and thus, longer petal lengths will mean increased petal widths and vice cersa. The correlation between petal length and petal width is not as strong within the Iris Setosa and Iris Versicolour, with Iris Versicolour having a strong correlation of this type.  
- However, the pairplot shows that there doesnt appear to be a species wide correlation between sepal width and petal length & width, likely due to the influence of the Iris Setosa, which has the largest sepal width and smallest measurements for petal length and petal width.
- Yet there does appear to be a species wide correlation between sepal length and petal length & width, likely due to the influence of the Iris Versicolour, which has the largest sepal lengths and largest measurements for petal length and petal width.
- As a result, I think that any ratios amongst the features such as sepal width and petal length & width may occur within one species type,
- Overall, it can be said that the differences set out between the Iris Setosa and the two other species is much more pronounced than any differences amongst each of the three species themselves. While the raw data may make it possible to distinguish the species type, there is some overlap of values and I don't think any firm conclusions on species type could be determined using this data alone.
