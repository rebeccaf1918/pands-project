...
#Dropping the ID Column since there is no impact of this column on the final Prediction  dataset = dataset.drop('Id',axis=1)
...
plt.subplots_adjust(hspace=0.5) #adjust space between plots as titles werent showing properly #
...
Setosa = iris_data[0:50] # includes 1st to 49th column   # how i split it; can also be done as above
Versicolor = iris_data[50:100]
Virginica = iris_data[100:150]
#rewrite below slightly
sea.histplot(Setosa["Sepal_Length(cm)"], color= "green")
sea.histplot(Versicolor["Sepal_Length(cm)"], color= "blue")
sea.histplot(Virginica["Sepal_Length(cm)"], color= "orange")
plt.title("Histogram - Sepal Length of 'Setosa, Versicolor and Virginica'")
plt.xlabel('Sepal_Length' + "\nSetosa, Versicolor and Virginica")
plt.ylabel('count')
plt.show()

sea.histplot(Setosa["Sepal_Width(cm)"], color= "green")
sea.histplot(Versicolor["Sepal_Width(cm)"], color= "blue")
sea.histplot(Virginica["Sepal_Width(cm)"], color= "orange")
...
sea.histplot(Setosa["Petal_Length(cm)"], color= "green")
sea.histplot(Versicolor["Petal_Length(cm)"], color= "blue")
sea.histplot(Virginica["Petal_Length(cm)"], color= "orange")
...
sea.distplot(Virginica["Petal_Width(cm)"], color= "orange")
...
##### Scatter Plots #######   DONE    MULTIVARITAE ANALYSIS OF CORRELATION FIRST BETWEEN SIMILAR CHARACTERISTICS THEN SPECIES
iris_data = pd.read_csv("iris_dataset.csv", names=column_names)
